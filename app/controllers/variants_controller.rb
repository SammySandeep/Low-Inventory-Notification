class VariantsController < ApplicationController
  ...
  def export_csv
    ...
    respond_to do |format|
      format.js { render "export_csv.js.erb", :locals => {:export_csv_success_message => export_csv_success_message} }
    end 
  end
  ...
  def update_csv_threshold
    ...
    respond_to do |format|
      format.js { render "update_csv_threshold.js.erb", :locals => {:import_csv_success_message => import_csv_success_message, :import_csv_error_message => import_csv_error_message} }
    end
  end
  ...
  def update
    ...
    respond_to do |format|
      format.js { render "update.js.erb", :locals => {:update_threshold_success_message => update_threshold_success_message, :update_threshold_error_message => update_threshold_error_message} }
    end   
  end
